...
tags:
  - software
  - project management
description: In which we talk about applying software development principles to medicine, and how awful that would be.
hero_image: ./sick-computer.png
hero_image_alt: Computer says BLURGH!
hero_image_credit: "SeekPNG"
hero_image_credit_link: https://www.seekpng.com/ipng/u2e6r5t4i1u2i1e6_dont-get-caught-with-the-flu-sick-computer/
---
