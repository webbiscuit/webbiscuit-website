...
description: In which we worry about AI and how it will affect software development.
hero_image: ./checkmate.png
hero_image_alt: How my chess games end
hero_image_credit: "@imgur"
hero_image_credit_link: https://i.imgur.com/gMTa7TU.png
---
