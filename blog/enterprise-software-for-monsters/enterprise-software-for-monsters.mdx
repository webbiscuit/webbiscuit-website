...
description: In which we present event based architecture as a solution to (and cause of) all of your enterprise software woes.
hero_image: ./vampcat.jpg
hero_image_alt: A Vampire
hero_image_credit: "@imgur"
hero_image_credit_link: https://i.imgur.com/VDSeZZ9.jpg
---
